...
function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center pt-32 pb-24">
        ...
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-28 items-center">
          ...
          >
            ...
            >
              ...
              for local businesses. Get your business online quickly and start growing.{' '}
            ...
            <motion.div
              ...
              className="flex gap-12 mt-16 pt-12 border-t border-white/[0.06]"
            >
              {[
    ...
    <div className="relative">
      ...
      <div className="relative bg-[#0A0A0A] rounded-2xl overflow-hidden border border-white/[0.06] shadow-2xl">
        ...
        <div className="p-5">
          ...
          <div className="rounded-xl bg-gradient-to-br from-[#1a1a1a] to-[#111] mb-4 overflow-hidden border border-white/[0.04]">
            <div className="p-5 text-center">
              <div className="text-4xl mb-3">🏢</div>
              <div className="text-base font-bold text-white mb-1">Your Business Name</div>
              <div className="text-xs text-neutral-400">Professional Landing Page</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2.5 mb-4">
            {[
              ...
              { icon: '💬', label: 'WhatsApp CTA' },
              { icon: '📍', label: 'Google Maps' },
            ].map((feature, i) => (
              <motion.div
                key={i}
                className="p-2.5 rounded-lg bg-[#111] border border-white/[0.04] text-center"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.6 + i * 0.1 }}
              >
                <div className="text-lg mb-1">{feature.icon}</div>
                <div className="text-[9px] text-neutral-400 leading-tight">{feature.label}</div>
              </motion.div>
            ))}
          </div>
          ...
          {/* WhatsApp CTA */}
          <motion.button
            className="w-full py-3 bg-[#25D366] rounded-lg text-white font-semibold text-xs flex items-center justify-center gap-2"
...
/* ═══════════════════════════════════════════════════════════════════════════
   CLIENTS SECTION - Scrolling News Feed
   ═══════════════════════════════════════════════════════════════════════════ */
...
function ClientsSection() {
  ...
  const clients = [
    { name: 'Unemplyd', logo: '/clients/unemployed.png' },
    { name: 'Nucleus', logo: '/clients/nucleus.png' },
    { name: 'Atoms', logo: '/clients/atoms.png' },
    { name: 'Meiporul', logo: '/clients/meiporul.png' },
    { name: 'Sri Sai Colors', logo: '/clients/sri-sai-colors.png' },
  ];
  
  // Duplicate clients for seamless infinite scroll (circular queue effect)
  // Duplicate exactly once so we have 2 identical sets - when animation reaches 50%, it loops seamlessly
  ...
  return (
    <section className="py-20 md:py-24 overflow-hidden">
      <div className="container-custom">
        ...
        >
          <span className="kicker mb-4 block">Our Clients</span>
          <h2 className="heading-lg text-white mb-4">
            Trusted by{' '}
            <span className="text-gradient-lime">Growing Businesses</span>
          </h2>
          <p className="body-md text-neutral-400 max-w-xl mx-auto">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="flex gap-8 animate-scroll-infinite">
            {duplicatedClients.map((client, i) => (
              ...
              >
                {/* Logo - Round */}
                <div className="w-24 h-24 rounded-full bg-[#111] border border-white/[0.06] p-4 flex items-center justify-center overflow-hidden group-hover:border-lime-400/30 transition-all duration-300">
                ...
                {/* Name */}
                <div className="text-sm font-medium text-neutral-300 text-center max-w-[120px]">
                  {client.name}
                </div>
              </div>
            ))}
